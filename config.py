...
ASTEROID_SPACE = pygame.Rect(
    0, 0, WINDOW_WIDTH - OBSTACLE_WIDTH, WINDOW_HEIGHT-OBSTACLE_HEIGHT)
...
PLAYER2_SPACE = pygame.Rect(
    WINDOW_WIDTH - SPACE_WIDTH - SPACESHIP_WIDTH - 10, HEALTH_BAR_SIZE[Y], SPACE_WIDTH, WINDOW_HEIGHT-SPACESHIP_HEIGHT)
